...
class PrivateChat(Container):
  def update_messages(self):
    ...
    self.content = Container(
        ...
        content=Column(
          ...
          controls=[
            Text(
              value='{}'.format(self.username_with),
              color=white
            ),
            ...
            Container(
              on_click= self.switch_page,
              data ='send_message_private ' + str(self.username_with),
              height=30,
              width=30,
              border_radius=10,
              bgcolor='#ffffff',
        ...
        #       Container(
        #         on_click= self.switch_page,
        #         data ='leave_group ' + str(self.username_with),
        #         height=30,
        #         width=30,
        #         border_radius=10,
        #         bgcolor='#ff0000',
  ...
  def __init__(self,switch_page, username_with, chat_client, screen_views=None):
    super().__init__()
    self.offset = transform.Offset(0,0,)
    self.username_with = username_with
    self.switch_page = switch_page
    self.expand = True
    self.chat_client = chat_client


    messages = self.chat_client.inbox(self.username_with)['message']
